<?php
class Constants {
    public static $displayNameCharacters = "Your first name must be between 2 and 1000 characters";
    public static $usernameCharacters = "Your username must be between 5 and 100 characters";
    ...
    public static $passwordLength = "Your password must be between 5 and 128 characters";
