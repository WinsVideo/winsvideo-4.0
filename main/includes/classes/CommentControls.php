<?php
    ...
    class CommentControls {
        ...
        private function createReplySection() {
            ...
            $videoUrl = $this->comment->getVideoUrl();
            $commentUrl = $this->comment->getCommentUrl();
            ...
            $postButtonAction = "postComment(this, \"$postedBy\", \"$videoUrl\", \"$commentUrl\", \"repliesSection\")";
        ...
        private function createLikeButton() {
            $commentUrl = $this->comment->getCommentUrl();
            $videoUrl = $this->comment->getVideoUrl();
            $action = "likeComment(this, \"$commentUrl\", \"$videoUrl\")";
            $class = "likeButton";
        ...
        private function createDislikeButton() {
            $commentUrl = $this->comment->getCommentUrl();
            $videoUrl = $this->comment->getVideoUrl();
            $action = "dislikeComment(this, \"$commentUrl\", \"$videoUrl\")";
            $class = "dislikeButton";
