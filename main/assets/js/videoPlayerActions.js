function likeVideo(button, videoUrl) {
    $.post("ajax/likeVideo.php", {videoUrl: videoUrl})
    .done(function(data) {
...
function dislikeVideo(button, videoUrl) {
    $.post("ajax/dislikeVideo.php", {videoUrl: videoUrl})
    .done(function(data) {
